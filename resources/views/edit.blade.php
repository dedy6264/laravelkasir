    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    <h2 class="title">Edit Products</h2>
                    @foreach($p as $p)
                    <form method="POST" action="/update">
                    @csrf
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Pruducts" name="nama_p" value="{{$p->nama_p}}">
                            <input class="input--style-2" type="text" placeholder="Pruducts" name="id" value="{{$p->id}}" hidden>
                        </div>
                        <div class="input-group">
